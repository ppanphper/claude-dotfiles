...
#   | ctx: in/total (X%) | free: 5h X% (reset) / 7d Y% (reset)
...
# 6. Quota remaining (100 - used_percentage) + reset countdown, straight from
# the official rate_limits fields — account-level, so consistent across machines.
